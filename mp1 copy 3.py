...
class PuzzleState():
    ...
    def can_move(self, direction): # DONE
        ...
        elif direction == "down" and zero_position[0] < 2:
            return True
        # Test if 0 tile can move up
        elif direction == "left" and zero_position[1] > 0:
            return True
        # Test if 0 tile can move down       
        elif direction == "right" and zero_position[1] < 2:
            return True
        else:
            return False
    ...
    def gen_next_state(self, direction):
        ...
        # Create Next state
        current_puzzle = np.copy(self.puzzle)
        next_state = PuzzleState(current_puzzle, (self.gcost+1),self)
